...
class VersionOptionsPinterest(BaseModel):
    """
    VersionOptionsPinterest
    """ # noqa: E501
    title: Optional[StrictStr] = None
    link: Optional[StrictStr] = None
    boards: Optional[VersionOptionsPinterestBoards] = None
    __properties: ClassVar[List[str]] = ["title", "link", "boards"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "link": obj.get("link"),
            "boards": VersionOptionsPinterestBoards.from_dict(obj["boards"]) if obj.get("boards") is not None else None
        })
        return _obj
