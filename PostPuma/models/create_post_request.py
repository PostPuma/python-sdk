...
class CreatePostRequest(BaseModel):
    ...
    schedule: Optional[StrictBool] = None
    schedule_now: Optional[StrictBool] = None
    queue: Optional[StrictBool] = None
    accounts: Optional[List[StrictInt]] = None
    tags: Optional[List[StrictInt]] = None
    versions: Optional[List[Version]] = None
    __properties: ClassVar[List[str]] = ["date", "time", "timezone", "schedule", "schedule_now", "queue", "accounts", "tags", "versions"]
